---
name: امنیت آنلاین خود را به‌روز رسانی کنید
goal:  رمز عبور و مدیریت داده‌های شخصی خود را به‌روزرسانی کنید. با ایجاد نسخه پشتیبان،  در برابر هکرها از خود محافظت کنید، و آگاهی‌تان را درباره نظارت گسترده افزایش دهید.
اهداف: 
  - به‌روزرسانی در مدیریت داده‌های شخصی و ابزارهایی که امنیت شما را افزایش می‌دهند.
  - پیاده‌سازی یک برنامه مدیریت رمز عبور امن و کاربرپسند.
  - پیاده‌سازی احراز هویت دو مرحله‌ای جهت تقویت امنیت و به حداقل رساندن خطرات هک.
---

# سفری به سوی حفاظت از داده‌های شما

به برنامه آموزشی اختصاص داده شده به امنیت دیجیتال خوش آمدید. این آموزش به گونه‌ای طراحی شده است که برای همه قابل دسترسی باشد، بنابراین به دانش قبلی از علوم کامپیوتر نیازی ندارید. هدف اصلی ما این است که شما را به دانش و مهارت‌های لازم جهت حرکت در دنیای دیجیتال به صورت ایمن‌تر و مطمئن‌تر مجهز کنیم.

این کار شامل پیاده‌سازی چندین ابزار خواهد بود، از جمله یک سرویس ایمیل امن، یک برنامه مدیریت رمز عبور، و نرم‌افزارهای مختلف برای افزایش امنیت آنلاین.

در این آموزش، هدف ما این نیست که شما را به یک کارشناس، فردی غیر قابل دستیابی در دنیای دیجیتال، و یا آسیب‌ناپذیر تبدیل کنیم، زیرا این امر غیرممکن است. در عوض، ما به شما راه‌حل‌های ساده و قابل دسترسی ارائه می‌دهیم تا شروع به تغییر عادات آنلاین خود کنید و کنترل حاکمیت دیجیتال خود را بازپس‌گیرید.
...
**هدف: مهارت‌های امنیتی خود را به‌روز رسانی کنید!**

به برنامه آموزشی اختصاص داده شده به امنیت دیجیتال خوش آمدید. این آموزش به گونه‌ای طراحی شده است که برای همه قابل دسترسی باشد، بنابراین نیازی به دانش قبلی در علوم کامپیوتر نیست. هدف اصلی ما این است که شما را با دانش و مهارت‌های لازم جهت حرکت در دنیای دیجیتال به صورت ایمن‌تر و مطمئن‌تر مجهز کنیم.

این امر شامل پیاده‌سازی چندین ابزار خواهد بود، از جمله یک سرویس ایمیل امن، یک برنامه مدیریت رمز عبور، و نرم‌افزارهای مختلف برای افزایش امنیت آنلاین.
...
بهداشت دیجیتال شما امری حیاتی در دنیای امروز است که به صورت فزاینده در حال دیجیتالی شدن می‌باشد. با وجود افزایش مداوم هک و نظارت گسترده، هنوز برای برداشتن اولین قدم و محافظت از خود دیر نشده است.
در این آموزش، ما تلاش نمی‌کنیم که شما را به یک کارشناس، فردی غیر قابل دستیابی در دنیای دیجیتال، و یا آسیب‌ناپذیر تبدیل کنیم، زیرا این امر غیرممکن است. در عوض، ما به شما راه‌حل‌های ساده و قابل دسترسی ارائه می‌دهیم تا شروع به تغییر عادات آنلاین خود کنید و کنترل حاکمیت دیجیتال خود را بازپس‌گیرید.
اگر به دنبال مهارت‌های پیشرفته‌تر در این موضوع هستید، منابع، آموزش‌ها، و دیگر دوره‌های آموزشی امنیت سایبری ما در دسترس شما هستند. در همین حین، در اینجا یک مرور کلی از برنامه ما برای چند ساعت آینده با هم ارائه شده است.

**بخش 1: هر آنچه باید درباره جستجوی آنلاین بدانید**
